...
if (play) {
   ...
   //RODADA
   //sorteia 2 cartas para o jogador e verifica se ambas as cartas são ases
   for (let i=0; i < 2;) {
      let carta = comprarCarta()
      playerHand.push(carta.texto)
      playerPoints.push(carta.valor)
      if ((playerPoints[0] === 11) && (playerPoints[1] === 11)) {
         i = i
      } else {
         i++
      }
   ...
   for (let i=0; i < 2;) {
      ...
      if ((pcPoints[0] === 11) && (pcPoints[1] === 11)) {
         i = i
      } else {
         i++
      }
