## Exercício 1
a) Concordo. Pois é mais fácil iterar sobre números e descobrir qual é a chave.
...
## Exercício 2
a) O código cria a conexão com o banco de dados (guardado na constante connection). A função createUser insere um novo usuário na tabela userTableName.
...
c) Transforma o parâmetro em string, que é o formato aceito pelo argument Secret do sign().
